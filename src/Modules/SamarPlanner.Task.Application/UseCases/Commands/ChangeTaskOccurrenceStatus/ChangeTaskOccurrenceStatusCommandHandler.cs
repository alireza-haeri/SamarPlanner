...
public class ChangeTaskOccurrenceStatusCommandHandler
(ITaskRepository taskRepository)
:IRequestHandler<ChangeTaskOccurrenceStatusCommand,Result<bool>>
{
    public async Task<Result<bool>> Handle(ChangeTaskOccurrenceStatusCommand request, CancellationToken cancellationToken)
    {
