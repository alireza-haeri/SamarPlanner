...
namespace SamarPlanner.Task.Application.UseCases.Commands.SoftDeleteOccurrenceTask;

public class SoftDeleteTaskOccurrenceCommandHandler
(ITaskRepository taskRepository)
:IRequestHandler<SoftDeleteTaskOccurrenceCommand,Result<bool>>
{
    public async Task<Result<bool>> Handle(SoftDeleteTaskOccurrenceCommand request, CancellationToken cancellationToken)
    {
        ...
        task.SoftDeleteOccurrence(request.Date);
