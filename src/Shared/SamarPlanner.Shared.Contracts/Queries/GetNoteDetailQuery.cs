...
public record GetNoteDetailQueryResponse(Guid NoteId, string? Title, string Text, DateTime UpdateAt, Guid? CategoryId,List<GetNoteDetailQueryResponseFile> Files);
